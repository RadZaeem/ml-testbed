...
class Model(ModelDesc):
    ...
    def _build_graph(self, inputs):
        ...
        self.cell = cell = rnn.MultiRNNCell([get_basic_cell() for _ in range(conf.num_layers)],state_is_tuple=True)
        ...
        with tf.variable_scope('LSTM', initializer=initializer):
            ...
            outputs, last_state = rnn.static_rnn(cell, input_list, state_var[0], 
