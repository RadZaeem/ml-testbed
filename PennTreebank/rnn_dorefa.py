...
class BasicLSTMCell(RNNCell):
  ...
  def __init__(self, num_units, forget_bias=1.0,
               state_is_tuple=True, activation=None, reuse=None, fg=None):
  ...
  def call(self, inputs, state):
    ...
    # if self.fg: self.apply(fg,new_state)
    # new_state=fg(new_state)
...
def _linear(args,
  ...
  # for a in args:
  #   try:
  #     if a.get_shape(): cleaned.append(a) 
  #   except AttributeError:
  #     print("a is" + repr(a) + ", skipping")
  # args = cleaned
